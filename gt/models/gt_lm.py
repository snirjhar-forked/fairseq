...
from .gt_decoder import GTDecoder
...
@dataclass
class GTLanguageModelConfig(FairseqDataclass):
...
@register_model("gt_lm", dataclass=GTLanguageModelConfig)
class GTLanguageModel(FairseqLanguageModel):
...
@register_model_architecture("gt_lm", "gt_lm_big")
def gt_lm_big(args):
...
@register_model_architecture("gt_lm", "gt_lm_wiki103")
@register_model_architecture("gt_lm", "gt_lm_baevski_wiki103")
def gt_lm_baevski_wiki103(args):
...
@register_model_architecture("gt_lm", "gt_lm_gpt")
def gt_lm_gpt(args):
...
@register_model_architecture("gt_lm", "gt_lm_gpt2_small")
def gt_lm_gpt2_small(args):
    args.decoder_embed_dim = safe_getattr(args, "decoder_embed_dim", 1024)
    args.decoder_ffn_embed_dim = safe_getattr(args, "decoder_ffn_embed_dim", 4096)
...
@register_model_architecture("gt_lm", "gt_lm_gpt2_tiny")
def gt_lm_gpt2_tiny(args):
...
@register_model_architecture("gt_lm", "gt_lm_gpt2_medium")
def gt_lm_gpt2_medium(args):
...
@register_model_architecture("gt_lm", "gt_lm_gpt2_big")
def gt_lm_gpt2_big(args):
...
@register_model_architecture("gt_lm", "gt_lm_gpt2_big_wide")
def gt_lm_gpt2_big_wide(args):
...
@register_model_architecture("gt_lm", "gt_lm_gpt2_bigger")
def gt_lm_gpt2_bigger(args):
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 2048)
    args.decoder_ffn_embed_dim = getattr(args, "decoder_ffn_embed_dim", 8192)
...
@register_model_architecture("gt_lm", "gt_lm_gpt3_small")
def gt_lm_gpt3_small(args):
    # 125M params
    args.decoder_layers = safe_getattr(args, "decoder_layers", 12)
    args.decoder_embed_dim = safe_getattr(args, "decoder_embed_dim", 768)
    args.decoder_attention_heads = safe_getattr(args, "decoder_attention_heads", 12)
...
@register_model_architecture("gt_lm", "gt_lm_gpt3_medium")
def gt_lm_gpt3_medium(args):
    # 350M params
    args.decoder_layers = safe_getattr(args, "decoder_layers", 24)
    args.decoder_embed_dim = safe_getattr(args, "decoder_embed_dim", 1024)
    args.decoder_attention_heads = safe_getattr(args, "decoder_attention_heads", 16)
...
@register_model_architecture("gt_lm", "gt_lm_gpt3_large")
def gt_lm_gpt3_large(args):
    # 760M params
    args.decoder_layers = safe_getattr(args, "decoder_layers", 24)
...
@register_model_architecture("gt_lm", "gt_lm_gpt3_xl")
def gt_lm_gpt3_xl(args):
    # 1.3B params
    args.decoder_layers = safe_getattr(args, "decoder_layers", 24)
...
@register_model_architecture("gt_lm", "gt_lm_gpt3_2_7")
def gt_lm_gpt3_2_7(args):
    # 2.7B params
...
@register_model_architecture("gt_lm", "gt_lm_gpt3_6_7")
def gt_lm_gpt3_6_7(args):
    # 6.7B params
    args.decoder_layers = safe_getattr(args, "decoder_layers", 32)
...
@register_model_architecture("gt_lm", "gt_lm_gpt3_13")
def gt_lm_gpt3_13(args):
    # 13B params
...
@register_model_architecture("gt_lm", "gt_lm_gpt3_175")
def gt_lm_gpt3_175(args):
    # 175B params
